    ...
    def forward(self, x, x_xyz=None, shape=None, multiview_data=None, decoder_3d=False):
        ...
        for i in range(self.num_layers):
            ...
            if self.cfg.MODEL.CROSS_VIEW_BACKBONE and decoder_3d:
                mv_data = {}
                mv_data['multi_scale_p2v'] = [multiview_data['multi_scale_p2v'][self.xyz_dict[f"res{i+2}"]]]
                xyz = [x_xyz[self.xyz_dict[f"res{i+2}"]]]
            else:
                mv_data = None
                xyz = None
            ...
            x_out, H, W, x, Wh, Ww = layer(
                x, Wh, Ww, 
                x_xyz=xyz, multiview_data=mv_data, shape=shape,
...
class D2SwinTransformer(SwinTransformer, Backbone):
    ...
    def forward(self, x, x_xyz=None, shape=None, multiview_data=None, decoder_3d=False):
        ...
        outputs = {}
        y = super().forward(x, x_xyz, shape, multiview_data, decoder_3d)
        for k in y.keys():
