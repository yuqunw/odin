...
def add_maskformer2_video_config(cfg):
    ...
    cfg.SCANNET_DATA_DIR = "/scratch/bcqn/ywu20/odin_processed/train_validation_database.yaml"
    cfg.S3DIS_DATA_DIR = "/scratch/bcqn/ywu20/odin_processed/train_validation_database.yaml"
